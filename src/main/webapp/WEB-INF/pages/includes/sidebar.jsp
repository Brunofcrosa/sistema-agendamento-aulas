    ...
    <nav class="sidebar-menu-wrapper">
        <ul class="menu-nav">
            ...
            <li class="menu-item ${pageName == 'home' ? 'menu-item-active' : ''}">
                <a class="menu-link" href="${pageContext.request.contextPath}/home">
                    <i class="menu-link-icon fa-solid fa-house" aria-hidden="true"></i>
            ...
            <li class="menu-item ${pageName == 'salas' && tela != 'encontrar' ? 'menu-item-active' : ''}">
                <a class="menu-link" href="${pageContext.request.contextPath}/sala">
                    <i class="menu-link-icon fa-solid fa-door-open" aria-hidden="true"></i>
                    <span class="menu-link-text">Salas</span>
                </a>
            </li>
            
            <li class="menu-item ${pageName == 'reservas' ? 'menu-item-active' : ''}">
                <a class="menu-link" href="${pageContext.request.contextPath}/reserva">
                    <i class="menu-link-icon fa-solid fa-calendar-check" aria-hidden="true"></i>
                    <span class="menu-link-text">Agendamento de Salas</span>
                </a>
            </li>
            
            <li class="menu-item ${pageName == 'docentes' ? 'menu-item-active' : ''}">
                <a class="menu-link" href="${pageContext.request.contextPath}/docente">
                    <i class="menu-link-icon fa-solid fa-chalkboard-user" aria-hidden="true"></i>
