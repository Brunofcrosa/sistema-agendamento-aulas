    ...
    <div class="app-shell">
        ...
        <main class="main-content">
            ...
            <c:choose>
                ...
                <c:when test="${msg == 'excluido'}"><div class="msg">Sala excluÃ­da!</div></c:when>
                ...
                <form action="sala" method="post" class="form-grid">
                    ...
                    <div class="form-field">
                        ...
                        <select name="ativa">
                            ...
                            <option value="" ${sala.id != null && !sala.ativa ? 'selected' : ''}>ManutenÃ§Ã£o</option>
                        </select>
                    </div>
            ...
            <section class="content-card">
                ...
                <table>
                    <tr><th>ID</th><th>NÃºmero da Sala</th><th>Capacidade MÃ¡xima</th><th>Projetor</th><th>Status</th><th>AÃ§Ãµes</th></tr>
                    <c:forEach var="s" items="${salas}" varStatus="status">
                        <tr>
                            <td>${status.index + 1}</td>
                            <td>${s.nome}</td>
                            <td>${s.capacidade}</td>
                            <td>${s.recursos == 'Projetor' ? 'Sim' : 'NÃ£o'}</td>
                            <td>${s.ativa ? 'Ativa' : 'ManutenÃ§Ã£o'}</td>
                            <td class="actions">
                ...
                <form action="sala" method="get" class="form-grid search-grid">
                    ...
                    <div class="form-field">
                        ...
                        <select name="diaSemana">
                            ...
                            <option value="TERÃ‡A" ${param.diaSemana == 'TERÃ‡A' ? 'selected' : ''}>TERÃ‡A</option>
            ...
            <section class="content-card">
                ...
                <table>
                    <tr><th>NÃºmero da Sala</th><th>Capacidade</th><th>Projetor</th><th>Status</th><th>AÃ§Ãµes</th></tr>
