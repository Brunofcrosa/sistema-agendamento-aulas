  ...
  <div class="d-flex flex-grow-1 justify-content-center align-items-center pb-5">
    <div class="card shadow border-0" style="width: 360px; border-top: 4px solid #0d6efd !important;">
      <div class="card-body p-4">
        <h3 class="text-center fw-bold mb-4" style="color: #032947;">Criar Conta</h3>
        ...
        <form action="usuario" method="post">
          ...
          <button type="submit" class="btn btn-primary btn-lg w-100 fw-bold">Cadastrar</button>
        </form>

        <div class="text-center mt-3">
          <a href="index.jsp" class="text-decoration-none fw-semibold">Voltar</a>
        </div>
